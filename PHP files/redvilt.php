...
$sql = "SELECT * FROM vilt WHERE id = '$idet'";
$result = $mysqli->query($sql);
...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Redigera vilt')?> </title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Redigera vilt')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item">
                                              <a href="#!"><?=gettext('Redigera vilt')?></a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Redigera befintlig vilt sensor')?></h5>
                                                        <span><?=gettext('Här kan du ställa in uppgifter för denna sensor. Du kan enbart ändra namnet då id numret ej kan ändras.')?></span>
                                                    </div>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/redvilt.php" novalidate>

                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Vilt sensorns namn')?></label>
                                                                <div class="col-sm-10">
...
<script type="text/javascript" src="assets/pages/form-validation/redvilt.js.php"></script>
