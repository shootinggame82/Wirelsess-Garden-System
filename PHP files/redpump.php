...
$sql = "SELECT * FROM pumpar WHERE id = '$idet'";
$result = $mysqli->query($sql);
...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Redigera pump')?> </title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Redigera pump')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item">
                                              <a href="#!"><?=gettext('Redigera pump')?></a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Redigera befintlig pump')?></h5>
                                                        <span><?=gettext('Här kan du ställa in uppgifter för denna pump. Du kan enbart ändra namnet då id numret ej kan ändras.')?></span>
                                                    </div>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/redpump.php" novalidate>
...
<script type="text/javascript" src="assets/pages/form-validation/redpump.js.php"></script>
