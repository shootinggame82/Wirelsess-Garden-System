...
echo "[";
$sql = "SELECT jordtemp, fukt, volt, datum, tid FROM jordfuktdag WHERE datum > DATE_SUB(NOW(), INTERVAL 1 MONTH) AND sensor = '$sensnr'";
...
$counter = 0;
    while ($row = $result->fetch_assoc()) {
        ...
        $weekday =  strftime("%d", strtotime($datumet));
        $tid[] = $weekday;
