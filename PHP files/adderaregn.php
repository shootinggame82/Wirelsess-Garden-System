...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Lägg till regnsensor')?> </title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Addera regnsensor')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Lägg till en ny regnsensor')?></h5>
                                                        <span><?=gettext('Här kan du lägga till en ny regnsensor. Dom håller koll på om det har regnat den senaste halvtimmen, om så fallet så körs ej bevattning.')?></span>
                                                    </div>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/adderaregn.php" novalidate>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Sensorns ID Nummer')?></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="idnr" id="idnr" placeholder="<?=gettext('Mellan 1501 - 2000')?>">
