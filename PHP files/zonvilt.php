...
$currentPage = 'zonvilt_'.$idet;
 ?>
<!DOCTYPE html>
<html lang="en">

<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Lägg till vilt i zon')?> </title>
  ...
  <?php include 'include/header.php'; ?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Addera vilt sensor till zon')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item">
                                              <a href="#!"><?=gettext('Addera vilt sensor')?></a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Lägg till en ny vilt sensor till odlingen')?></h5>
                                                        <span><?=gettext('Koppla en ny vilt sensor till denna odling. Välj en befintlig sensor från listan för att koppla den.')?></span>
                                                    </div>
                                                    <?php if ($existerar == 1 && $sensorfinns == 1) {
     ?>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/zonvilt.php" novalidate>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Sensor')?></label>
                                                                <div class="col-sm-10">
     ...
     ?>
         ...
         ?>
                                                          <p><?=gettext('Du måste lägga till vilt sensorer först')?></P>
                                                    <?php
     } ?>
                                                    </div>
                                              <?php
...
<script type="text/javascript" src="assets/pages/form-validation/zonvilt.js.php"></script>
