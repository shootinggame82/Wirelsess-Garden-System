...
<head>
  ...
  <?php include 'include/header.php'; ?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Redigera vilt sirener')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5><?=gettext('Redigera vilt sirener')?></h5>
                                                <span><?=gettext('Här ser du lista på dina sirener som finns i systemet. Du kan ändra dess namn eller ta bort dom. (dom försvinner från vilt sensorer då.)')?></span>
                                            </div>
    ...
    <script type="text/javascript" src="assets/js/redigeraviltsiren.js.php"></script>
</body>
