...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Zon vilt sensorer')?></title>
  ...
  <?php include 'include/header.php'; ?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Zon vilt')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5><?php echo $azonnamn; ?> <?=gettext('vilt sensorer')?></h5>
                                                <span><?=gettext('Här ser du alla vilt sensorer som är kopplad till denna zon. Genom att klicka på radera så tar du bort sensorn från zonen (ej från systemet)')?></span>
                                            </div>
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                          <?php    $sql = "SELECT * FROM zonvilt WHERE zon = '$idet' ORDER BY id ASC";
                                                            ...
                                                            <tr>
                                                                <th scope="row"><?php echo $enviltnr; ?></th>
                                                                <td><?php echo $enviltnamn; ?></td>
                                                                <td><?php echo $enviltvolt; ?></td>
                                                                <td><a href="#!" onclick="radera(<?php echo $enviltid; ?>, <?php echo $idet; ?>)"><?=gettext('Radera')?></A></td>
                                                            </tr>
                                                            <?php
                                                                          }
                                                                      }
    ...
    <script type="text/javascript" src="assets/js/zonvilt.js.php"></script>
</body>
