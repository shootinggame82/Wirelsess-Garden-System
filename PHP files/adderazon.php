...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Lägg till zon')?> </title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Addera zon')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Lägg till en ny zon')?></h5>
                                                        <span><?=gettext('Zoner är där du delar upp dina olika sensorer i grupper för att kunna se statistik och sköta bevattning m.m. Sensorer och sånt lägger du till sedan när du är inne i zonen.')?></span>
                                                    </div>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/adderazon.php" novalidate>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Zon namn')?></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="namn" id="namn" placeholder="<?=gettext('Ex: Tomat odlingen')?>">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                  <textarea rows="5" cols="5" name="besk" id="besk" class="form-control" placeholder="<?=gettext('En lämplig beskrivning')?>"></textarea>
                                                                    <span class="messages"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
...
<script type="text/javascript" src="assets/pages/form-validation/zon.js.php"></script>
