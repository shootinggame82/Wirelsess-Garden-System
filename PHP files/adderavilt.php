...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Lägg till vilt sensor')?> </title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Addera vilt')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Lägg till en ny vilt sensor')?></h5>
                                                        <span><?=gettext('Vilt sensorn reagerar på rörelse och larmar och rörelse uppstår. Lägg till en ny vilt sensor här som sen kopplas till zoner.')?></span>
                                                    </div>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/adderavilt.php" novalidate>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Sensorns ID Nummer')?></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="idnr" id="idnr" placeholder="<?=gettext('Mellan 6501 - 7000')?>">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Vilt siren')?></label>
                                                                <div class="col-sm-10">
                                                                  <select name="pump" class="form-control" id="pump">
                                                                    <?php
                                                                    $sql = "SELECT * FROM sirenvilt";
   $result = $mysqli->query($sql);
...
<script type="text/javascript" src="assets/pages/form-validation/vilt.js.php"></script>
