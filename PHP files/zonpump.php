...
$currentPage = 'zonpump_'.$idet;
 ?>
<!DOCTYPE html>
<html lang="en">

<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Lägg till pump i zon')?> </title>
  ...
  <?php include 'include/header.php'; ?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Addera pump till zon')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Lägg till en ny pump till odlingen')?></h5>
                                                        <span><?=gettext('Koppla en ny bevattnings pump till denna odling. Välj en befintlig pump från listan för att koppla den.')?></span>
                                                    </div>
                                                    <?php if ($existerar == 1 && $sensorfinns == 1) {
     ?>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/zonpump.php" novalidate>
     ...
     ?>
         ...
         ?>
                                                          <p><?=gettext('Du måste lägga till pumpar först')?></P>
                                                    <?php
     } ?>
                                                    </div>
                                              <?php
...
<script type="text/javascript" src="assets/pages/form-validation/zonpump.js.php"></script>
