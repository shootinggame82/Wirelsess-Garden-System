...
$sql = "SELECT * FROM loggbok WHERE id = '$idet'";
...
if ($result->num_rows == 1) {
    while ($row = $result->fetch_assoc()) {
        ...
        $loggdokument = $row["dokument"];
        $loggzon = $row["zon"];
    }
}
$currentPage = 'zonloggar_'.$loggzon;
 ?>
<!DOCTYPE html>
<html lang="en">

<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Redigera logg rapport')?> </title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Redigera Zon logg')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!"><?=gettext('Redigera logg rapport')?></a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5><?=gettext('Redigera din logg rapport')?></h5>
                                                <span><?=gettext('Här kan du redigera din logg rapport ifall du behöver göra ändringar.')?></span>
                                            </div>
                                            <div class="card-block">
                                              <form id="main" method="post" action="functions/zonloggedit.php">
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label"><?=gettext('Rubrik')?></label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="rubrik" id="rubrik" value="<?php echo $loggrubrik; ?>" placeholder="<?=gettext('En lämplig rubrik')?>">
                                                        <span class="messages"></span>
                                                    </div>
                                                </div>
                                                <textarea name="dokument" id="editor2">
                                                    <?php echo $loggdokument; ?>
                                                </textarea>
