...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Lägg till vilt siren')?> </title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Addera viltsiren')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item">
                                              <a href="#!"><?=gettext('Addera vilt siren')?></a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Lägg till en ny vilt siren')?></h5>
                                                        <span><?=gettext('Vilt siren är en siren som aktiveras om vilt sensorerna är aktiv och registrerar rörelse.')?></span>
                                                    </div>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/adderaviltsiren.php" novalidate>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Siren ID Nummer')?></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="idnr" id="idnr" placeholder="<?=gettext('Mellan 8501 - 7000')?>">
                                                                    <span class="messages"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Siren Namn')?></label>
                                                                <div class="col-sm-10">
...
<script type="text/javascript" src="assets/pages/form-validation/viltsiren.js.php"></script>
