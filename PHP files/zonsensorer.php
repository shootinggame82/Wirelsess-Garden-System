...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Zon sensorer')?></title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Zon jord sensorer')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5><?php echo $azonnamn; ?> <?=gettext('jord sensorer')?></h5>
                                                <span><?=gettext('Här ser du lista på dina sensorer som är kopplade till denna zon. Genom att klicka på radera så tar du bort sensorn från zonen (ej från systemet)')?></span>
                                            </div>
