...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Redigera pumpar')?></title>
  ...
  <?php include 'include/header.php'; ?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Redigera bevattnings pumpar')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5><?=gettext('Redigera bevattnings pumpar')?></h5>
                                                <span><?=gettext('Här ser du en lista på alla dina pumpar. Du kan ändra dess värden här eller tabort dom (dom försvinner även från zoner då.) Notera att tar du bort en pump kommer sensorer kopplade till pumpen eller zoner bli utan denna pump.')?></span>
                                            </div>
    ...
    <script type="text/javascript" src="assets/js/redigerapump.js.php"></script>
</body>
