...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Redigera zoner')?></title>
  ...
  <?php include 'include/header.php'; ?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Redigera zoner')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item">
                                              <a href="#!"><?=gettext('Redigera zoner')?></a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5><?=gettext('Redigera zoner')?></h5>
                                                <span><?=gettext('Här ser du lista på dina zoner som finns i systemet. Du kan ändra dess värden här eller tabort dom (inga sensorer, pumpar, statistik försvinner)')?></span>
                                            </div>
                                                    ...
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                <th><?=gettext('Nr')?></th>
                                                                <th><?=gettext('Namn')?></th>
                                                                <th><?=gettext('Beskrivning')?></th>
                                                                <th><?=gettext('Meny')?></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                          <?php    $sql = "SELECT * FROM zoner";
                                                              $result = $mysqli->query($sql);
    ...
    <script type="text/javascript" src="assets/js/redigerazon.js.php"></script>
</body>
