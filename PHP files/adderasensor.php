...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Lägg till sensor')?> </title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Addera sensor')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item">
                                              <a href="#!"><?=gettext('Addera sensor')?></a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Lägg till en ny sensor')?></h5>
                                                        <span><?=gettext('Här kan du lägga till en ny jord sensor till systemet. Ange sensorns nummer namn och koppla en pump till den om så önskas. Utan pump så kan ej automatisk bevattning användas.')?></span>
                                                    </div>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/adderasensor.php" novalidate>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Sensorns ID Nummer')?></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="idnr" id="idnr" placeholder="<?=gettext('Mellan 4501 - 5000')?>">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label"><?=gettext('Pump')?></label>
                                                                <div class="col-sm-10">
                                                                    <select name="pump" class="form-control" id="pump">
                                                                      <option value="0"><?=gettext('Ingen pump')?></option>
                                                                      <?php
...
<script type="text/javascript" src="assets/pages/form-validation/form-validation.js.php"></script>
