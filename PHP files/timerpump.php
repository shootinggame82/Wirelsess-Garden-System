...
<head>
    <title><?php echo $sys_name; ?> - <?=gettext('Pump timer')?> </title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Pump timer')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                            ...
                                            <div class="col-sm-12">
                                              <div class="card">
                                                  <div class="card-header">
                                                      ...
                                                      <span><?=gettext('Här ser du alla pump timers som du har i systemet. Dessa tider kommer pumpen automatiskt att gå. Notera att i regel så gäller inte slut tiden då pumparna har inbyggd avstängning efter viss tid.')?></span>
                                                  </div>
                                                                ...
                                                                <?php    $sql = "SELECT * FROM pumptimer";
                                                                    ...
                                                                    if ($result->num_rows > 0) {
                                                                        while ($row = $result->fetch_assoc()) {
                                                                            ...
                                                                            $sql2 = "SELECT * FROM pumpar WHERE id = '$pump'";
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><?=gettext('Pump timers')?></h5>
                                                        <span><?=gettext('Här kan du lägga till och redigera befintliga timers. Timers gör att du kan automatiskt starta bevattningen önskade tider. Du kan ha flera tider på samma pump.')?></span>
                                                    </div>
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="functions/adderatimer.php" novalidate>
...
<script type="text/javascript" src="assets/pages/form-validation/pumptimer.js.php"></script>
<script src="assets/js/pcoded.min.js"></script>
<script src="assets/js/vertical/vertical-layout.min.js"></script>
<script src="assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
<script type="text/javascript" src="assets/js/script.js.php"></script>
<script type="text/javascript" src="assets/js/pumptimer.js.php"></script>
</body>
