...
$sql = "SELECT * FROM zoner WHERE id = '$zon'";
...
<head>
  <title><?php echo $sys_name; ?> - <?=gettext('Sensor statistik')?> </title>
                ...
                <div class="row align-items-center">
                  <div class="col-md-8">
                    <div class="page-header-title">
                      <h4 class="m-b-10"><?=gettext('Sensor statistik för')?> <?php echo $sensnamn; ?></h4>
                    </div>
                    <ul class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="#!"><?=gettext('Statistik')?></a>
                      </li>
                    </ul>
                  </div>
                </div>
                      ...
                      <div class="col-lg-12">
                        <div class="card">
                          <div class="card-header">
                            ...
                            <span><?=gettext('Statistik hämtat från idag för vald sensor.')?></span>
                          </div>
                      ...
                      <div class="col-lg-12">
                        <div class="card">
                          <div class="card-header">
                            ...
                            <span><?=gettext('Statistik hämtat från denna vecka för vald sensor.')?></span>
                          </div>
                          <div class="card-block">
                            <div id="morris-vecka"></div>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="card">
                          <div class="card-header">
                            ...
                            <span><?=gettext('Statistik hämtat från denna månad för vald sensor.')?></span>
                          </div>
                          <div class="card-block">
                            <div id="morris-manad"></div>
                          </div>
                        </div>
                      </div>
...
<![endif]-->
  ...
  <script type="text/javascript" id="sensorid" data-name="<?php echo $sensnr; ?>" src="assets/pages/chart/morris/morris-custom-chart.js"></script>
