    ...
    var constraints = {
      ...
      idnr: {
        ...
        length: {
          minimum: 4,
          maximum: 4,
          message: "<?=gettext('minst 4 tecken och max 4 tecken')?>"
        },

        numericality: {
          onlyInteger: true,
          message: "<?=gettext('Du kan bara ange siffror här')?>"
        ...
        format: {
          ...
          pattern: "[0-9]+",
          message: "<?=gettext('endast siffror')?>"
        }
      },
    };
      ...
      if (!errors) {
        ...
        jQuery.ajax({
          ...
          success: function(data) {
            ...
            if (fel == "true") {
              if (kod == "0") {
                alert('<?=gettext('Den angivna vilt sirenen finns redan med i systemet.')?>');
              } else if (kod == "1") {
              ...
              alert('<?=gettext('Vilt sirenen har blivit tillagd')?>');
              $("#idnr").val("");
              $("#namn").val("");
            }
          }
