        ...
        HandleSubMenuTrigger: function() {
            switch (settings.SubMenuTrigger) {
                case 'hover':
                    ...
                    (currentSize >= 992) ? bindTwo('hover'): bindTwo('click');
                    ...
                    $window.resize(function() {
                        ...
                        if (newSize >= 992 && currentEvent != 'hover') {
                            bindTwo('hover');
                        } else if (newSize < 992 && currentEvent != 'click') {
                            bindTwo('click');
                        }
        ...
        HandleMenuTrigger: function() {
            ...
            switch (settings.MenuTrigger) {
                case 'hover':
                    ...
                    var currentEvent = '';
                    // Attach current event on load
                    (currentSize >= 992) ? bindOne('hover'): bindOne('click');
                    // Atach window resize event
                    $window.resize(function() {
                        // get windows new size
                        var newSize = $window.width();
...
$(window).on('load', function() {
    ...
    // $('pcoded-inner-navbar li.active').children('.pcoded-submenu').slideDown();
});
