...
<head>
  ...
  <?php include 'include/header.php'; ?>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10"><?=gettext('Redigera vilt sensorer')?></h4>
                                      </div>
                                      <ul class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item">
                                              <a href="#!"><?=gettext('Vilt sensorer')?></a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5><?=gettext('Redigera vilt sensorer')?></h5>
    ...
    <script type="text/javascript" src="assets/js/redigeravilt.js.php"></script>
</body>
